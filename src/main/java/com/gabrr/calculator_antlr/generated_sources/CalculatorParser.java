...
public class CalculatorParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, MUL=3, DIV=4, ADD=5, SUB=6, NUMB=7, NEWLINE=8, WS=9;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, "MUL", "DIV", "ADD", "SUB", "NUMB", "NEWLINE", "WS"
		};
	}
	...
	public static class ParenthContext extends ExprContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof CalculatorListener ) ((CalculatorListener)listener).enterParenth(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof CalculatorListener ) ((CalculatorListener)listener).exitParenth(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CalculatorVisitor ) return ((CalculatorVisitor<? extends T>)visitor).visitParenth(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class AddOrSubContext extends ExprContext {
		public ExprContext numb1;
		public Token op;
		public ExprContext numb2;
	...
	public static class NumbContext extends ExprContext {
		public TerminalNode NUMB() { return getToken(CalculatorParser.NUMB, 0); }
		public NumbContext(ExprContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof CalculatorListener ) ((CalculatorListener)listener).enterNumb(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof CalculatorListener ) ((CalculatorListener)listener).exitNumb(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CalculatorVisitor ) return ((CalculatorVisitor<? extends T>)visitor).visitNumb(this);
			else return visitor.visitChildren(this);
		}
	}
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						((MulOrDivContext)_localctx).numb1 = _prevctx;
						...
						setState(16);
						((MulOrDivContext)_localctx).numb2 = expr(3);
						}
						break;
					case 2:
						{
						_localctx = new AddOrSubContext(new ExprContext(_parentctx, _parentState));
						((AddOrSubContext)_localctx).numb1 = _prevctx;
						pushNewRecursionContext(_localctx, _startState, RULE_expr);
						setState(17);
						...
						setState(19);
						((AddOrSubContext)_localctx).numb2 = expr(2);
						}
						break;
					}
					} 
	...
	public static final String _serializedATN =
		...
		"\n\3\2\2\2\17\30\3\2\2\2\20\21\f\4\2\2\21\22\t\2\2\2\22\27\5\4\3\5\23"+
		"\24\f\3\2\2\24\25\t\3\2\2\25\27\5\4\3\4\26\20\3\2\2\2\26\23\3\2\2\2\27"+
